...
function OPResgistradasSelectEndLineP2() {
    ...
    try {
        $.ajax({
            type: "POST",
            url: "DataOP.ashx?Action=OPRegistradas&GrupoLinea=" + document.getElementById('SelectGrupo').value + "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    if (estatusOP_ != "Terminada") {
                        ...
                        if (document.getElementById('spanEstatusL1').innerHTML != nuevoestatusL1)
                            OPResgistradasSelect();//location.reload();
                        else
...
function OPResgistradasSelectTable() {
    ...
    try {
        $.ajax({
            type: "POST",
            url: "DataOP.ashx?Action=OPRegistradasTable&GrupoLinea=" + document.getElementById('SelectGrupo').value + "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
...
function InciarLavado() {
    ...
    try {
        ...
        swal('Iniciando  Lavado...', 'Estamos iniciando el lavado, por favor espere, no cierre esta ventana hasta que el proceso termine…', 'warning');
        $.ajax({
            type: "POST",
            ...
            success: function (data) {
                ...
                OPResgistradasSelect();
                swal('Lavando', 'Inició el lavado correctamente...', 'success');
                document.getElementById('divIniciarLavado').style.display = 'none';
                document.getElementById('divLavando').style.display = 'inline';
...
function IniciandoLineaPrimeraVezv2(Lid) {
    ...
    try {
        ...
        swal('Iniciando Línea...', 'Estamos iniciando la Línea No ' + Lid + ', por favor espere, no cierre esta ventana hasta que el proceso termine…', 'warning');
        $.ajax({
            type: "POST",
...
function ReinicioParadaLineasdeProduccion(tiempo) {
    ...
    try {
        ...
        if (message != "") {
            ...
            $.ajax({
                type: "POST",
                url: "DataOP.ashx?Action=DetenerLinea&OP=" + document.getElementsByName('DataspanOP')[0].value + "&ProductoOP=" + document.getElementsByName('NAVI')[0].value + "&Descripcion=" + document.getElementsByName('NombreProducto')[0].value + "&Cantidad=" + document.getElementsByName('UnidadesFabricar')[0].value + "&Ubicacion=-&CodCliente=-&NombreCliente=" + document.getElementsByName('Cliente')[0].value + "&TiempoLavado=" + document.getElementsByName('Lavado')[0].value + "&DescripLavado=" + document.getElementById('normal-select-7').innerText + "&L1=" + document.getElementById('txtL1').value + "&L2=" + document.getElementById('txtL2').value + "&L3=" + document.getElementById('txtL3').value + "&LP=" + document.getElementById('txtL').value + "&Tiempo=" + tiempo + "&GrupoLinea=" + document.getElementById('SelectGrupo').value + " ",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
...
function OPMonitoreadaSiguientesUpdates() {
    ...
    try {
        $.ajax({
            type: "POST",
            url: "DataOP.ashx?Action=OPRegistradasFinalLinea&GrupoLinea=" + document.getElementById('SelectGrupo').value + "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
                var exists = false;
...
function Limpiar() {
    ...
    document.getElementById('HiddenEstadoOP').value = 5;
    document.getElementById('txtL1').value = "";
    document.getElementById('txtL2').value = "";
    document.getElementById('txtL3').value = "";
    document.getElementsByName('EstadoOP')[0].value = "";
    document.getElementsByName('EstadoOP')[1].value = "";
    document.getElementsByName('EstadoOP')[2].value = "";
    document.getElementsByName('EstadoOP')[3].value = "";
    document.getElementsByName('EstadoOP')[4].value = "";
    document.getElementsByName('DataspanOP')[0].value = "";
    document.getElementsByName('DataspanOP')[1].value = "";
    document.getElementsByName('DataspanOP')[2].value = "";
    document.getElementsByName('DataspanOP')[3].value = "";
    document.getElementsByName('DataspanOP')[4].value = "";
    document.getElementsByName('NAVI')[0].value = "";
    document.getElementsByName('NAVI')[1].value = "";
    document.getElementsByName('NAVI')[2].value = "";
    document.getElementsByName('NAVI')[3].value = "";
    document.getElementsByName('NAVI')[4].value = "";
    document.getElementsByName('NombreProducto')[0].value = "";
    document.getElementsByName('NombreProducto')[1].value = "";
    document.getElementsByName('NombreProducto')[2].value = "";
    document.getElementsByName('NombreProducto')[3].value = "";
    document.getElementsByName('NombreProducto')[4].value = "";
    document.getElementsByName('UnidadesFabricar')[0].value = "";
    document.getElementsByName('UnidadesFabricar')[1].value = "";
    document.getElementsByName('UnidadesFabricar')[2].value = "";
    document.getElementsByName('UnidadesFabricar')[3].value = "";
    document.getElementsByName('UnidadesFabricar')[4].value = "";
    document.getElementsByName('Cliente')[0].value = "";
    document.getElementsByName('Cliente')[1].value = "";
    document.getElementsByName('Cliente')[2].value = "";
    document.getElementsByName('Cliente')[3].value = "";
    document.getElementsByName('Cliente')[4].value = "";
    document.getElementsByName('Lavado')[0].value = "";
    document.getElementsByName('Lavado')[1].value = "";
    document.getElementsByName('Lavado')[2].value = "";
    document.getElementsByName('Lavado')[3].value = "";
    document.getElementsByName('Lavado')[4].value = "";
    document.getElementById('spanEstatusL1').innerHTML = "";
    document.getElementById('spanEstatusL2').innerHTML = "";
    document.getElementById('spanEstatusL3').innerHTML = "";
    document.getElementById('divLavando').style.display = 'none';
