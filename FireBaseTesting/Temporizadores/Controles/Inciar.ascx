<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Inciar.ascx.cs" Inherits="FireBaseTesting.Temporizadores.Controles.Inciar" %>

				
<div id="DivIncio">
	<h3 style="color:#808080;font-size:30px;">Datos de <strong> Incio </strong></h3>
<table>
 <tr>
 <td>
...
<div id="divFinalizar">
<h3 style="color:#808080;font-size:30px;">Datos de Finalización</h3>
<table>
<tr>
<td>
