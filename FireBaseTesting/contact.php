...
$e_subject = 'Correo del sitio web www.ceafta.com Enviado por: ' . $name . '.';

$e_body = "Te envió un correo:  $name desde el formulario de contacto del sitio web www.ceafta.com
El mensaje adicional es el siguiente:
" . "\r\n" . "\r\n";
$e_content = "\"$comments\"" . "\r\n" . "\r\n";
...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><p>Muchas Gracias $name, 
Su mensaje ha sido enviado.</p></div></fieldset>"; }