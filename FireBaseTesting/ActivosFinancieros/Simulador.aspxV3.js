...
function LlenarExel(objData, Sesiones, RapidaInicial, RapidaFinal, LentaInicial, LentaFinal) {
    ...
    document.getElementById('spanEsperando').style.color = "yellow";
    document.getElementById('spanEsperando').innerHTML = "El proceso de consulta ha terminado, ahora estamos realizando los cálculos, por favor espere..."; 
    try {
        $.ajax({
            type: "POST",
            ...
            failure: function (r) {
                ...
                document.getElementById('spanEsperando').style.color = "red";
                document.getElementById('spanEsperando').innerHTML = "Failure: El proceso no terminó correctamente, por favor vuelva a intentarlo";
                document.getElementById('btnRecarlcular').style.display = "inline";
            ...
            error: function (r) {
                ...
                document.getElementById('spanEsperando').style.color = "red";
                document.getElementById('spanEsperando').innerHTML = "Error: El proceso no terminó correctamente, por favor vuelva a intentarlo";
                document.getElementById('btnRecarlcular').style.display = "inline";
