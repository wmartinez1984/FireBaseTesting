<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="FireBaseTesting.ActivosFinancieros.login" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        function Loginvalidate() {
            ...
            if (document.getElementById('username').value == "test@test.com" && document.getElementById('password').value == "test") {               
                
                window.location.href = 'home'; 
               
            }          
            else {
                document.getElementById('spanMessage').innerHTML = "Usuario o contraseña no válidos";
...
<body>
    <form   onsubmit="return false">
      ...
      <input type="submit" value="Log In"  onclick="Loginvalidate();"/>
     
      <div class="email">
           <span id="spanMessage" style="color:red"></span><br />
